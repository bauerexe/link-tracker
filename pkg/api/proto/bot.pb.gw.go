...
func request_Bot_UpdateLink_0(ctx context.Context, marshaler runtime.Marshaler, client BotClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Bot_UpdateLink_0(ctx context.Context, marshaler runtime.Marshaler, server BotServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateLinkRequest
	var metadata runtime.ServerMetadata
...
func RegisterBotHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BotServer) error {
	...
	mux.Handle("POST", pattern_Bot_UpdateLink_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/bot.v1.Bot/UpdateLink", runtime.WithHTTPPathPattern("/updates"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Bot_UpdateLink_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Bot_UpdateLink_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterBotHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BotClient) error {
	...
	mux.Handle("POST", pattern_Bot_UpdateLink_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/bot.v1.Bot/UpdateLink", runtime.WithHTTPPathPattern("/updates"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Bot_UpdateLink_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Bot_UpdateLink_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"updates"}, ""))
)

var (
	forward_Bot_UpdateLink_0 = runtime.ForwardResponseMessage
)
